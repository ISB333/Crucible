...
Lets the models research CPU/llama.cpp inference techniques on demand instead of
guessing. Requires TAVILY_API_KEY in the environment.
"""
...
WEB_SEARCH_TOOL = {
    "name": "web_search",
    "description": (
        "Search the web for current CPU/llama.cpp inference-optimization techniques "
        "(speculative decoding, NUMA, huge pages, batching, MoE tuning, quantization). "
        "Returns titled snippets. Use this to ground your config edits in real methods."
    ),
    "input_schema": {
        "type": "object",
